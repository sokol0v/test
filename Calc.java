...
public class Calc {
    ...
    public static void main (String[] args) {
        ...
        if (userInput.length() != 3) {
            throw new IllegalArgumentException("Only one math operation allowed");
        }
    ...
    private static int romanToNumber (String roman) {
        try {
            ...
            throw new InputMismatchException("Wrong format of data");
        }
        return -1;
    }
    ...
    public static int calculated (int num1, int num2, char op) {
        ...
        switch (op) {
            ...
            case '/':
                ...
                break;
            default:
                throw new IllegalArgumentException("Wrong operation character");
        }
        return result;
    }
}
